...
<?php
      ...
      if(isset($_GET['id'])){
$more = htmlentities(mysqli_real_escape_string($conn, $_GET['id']));
 $sql_select_posts = mysqli_query($conn, "SELECT * FROM posts WHERE id = '$more'");
...
?>
                    ...
                    <div class="card mb-3" style = "border:2px solid green; border-radius:20px; box-shadow:3px 1px 5px 2px; background-color:light">
                        ...
                        <div class = "card-body"> 
                            <label class = "text-dark">Posted_on: <?php echo date("d:m:y", strtotime($row['created_at'])) ?></label>
                       <hr>
  ...
  ?>
       ...
       <section class = "py-3">
        <div class="container-fluid">
            <h2 class = "text-center">RELATED_POSTS</h2>
        </div>
